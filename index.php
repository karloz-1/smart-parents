...
<body>
    <?php include 'includes/landing_header.php'?> <!-- Incluye el header -->
    <main class="main">
        <section class="main_content">
            <div>
                <h1 class="main_title">SMART PARENTS</h1>
                <p class="main_text">
                ...
                <a href="#" class="main_login_btn">Iniciar Sesión</a>
            </div>
        </section>
        <section>
            <img src="assets/img/id_card.svg" alt="ilustracion de tarjeta">
        </section>
    </main>
</body>
</html>