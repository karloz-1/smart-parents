    ...
    <div class="form">
      <form action="/smart-parents/actions/eventos/actualizar_eventos.php" method="POST" class="form_content">
        ...
        <div class="form_usuario">
          ...
          <input type="text"
            value="<?= $evento['nombre1_u1'] . " " . $evento['nombre2_u1'] . " " . $evento['apellido1_u1'] . " " . $evento['apellido2_u1']; ?>"
            disabled>
        </div>
        <div class="form_descripcion">
          <label for="descripcion_del_evento">Descripción del evento</label>
          <textarea name="descripcion_del_evento" rows="4" required>
            <?= $evento['descripcion'] ?>
          </textarea>
        </div>
        <div class="form_registrado_por">
          ...
          <input type="text"
            value="<?= $evento['nombre1_u2'] . " " . $evento['nombre2_u2'] . " " . $evento['apellido1_u2'] . " " . $evento['apellido2_u2']; ?>"
            disabled>
        </div>
