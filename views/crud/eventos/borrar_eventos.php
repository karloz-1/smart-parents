    ...
    <main>
        <div class="card_borrar_usuario">
                <div class="card_title">
                    <h2>¿Esta seguro de eliminar este evento?</h2>
                </div>
                <div class="card_content">
                    <form action="/smart-parents/actions/eventos/borrar_eventos.php" method="POST">
                        ...
                        <div class="card_item">
                            ...
                            <p class="black"><?= $evento['tipo_evento']; ?></p>
                        </div>
                        <hr>
                        <div class="card_item">
                            <label for="usuario_del_evento">Usuario del evento</label>
                            <p class="black"><?= $evento['nombre1_u1'] . " ". $evento['nombre2_u1'] . " ". $evento['apellido1_u1'] . " ". $evento['apellido2_u1']; ?></p>
                        </div>
                        <hr>
                        <div class="card_item">
                            <label for="descripcion_del_evento">Descripción del evento</label>
                            <p class="black"><?= $evento['descripcion']; ?></p>
                        </div>
                        <hr>
                        <div class="card_item">
                            <label for="registrado_por">Registrado por</label>
                            <p class="black"><?= $evento['nombre1_u2'] . " ". $evento['nombre2_u2'] . " ". $evento['apellido1_u2'] . " ". $evento['apellido2_u2']; ?></p>
                        </div>
                        <hr>
