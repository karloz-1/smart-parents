...
<body>
    <?php include $_SERVER['DOCUMENT_ROOT'] . '/smart-parents/includes/dashboard_header.php'; ?>  <!-- Incluye archivo php con el header de la pagina -->
    <main>
        <div class="title">
            <h1>Permiso denegado</h1>
        </div>
        <p class="msj">No tienes permiso para ver esta página. <br><br> El error <span class="bold">403 Forbidden</span> indica que, aunque has iniciado sesión, tu cuenta no tiene los permisos necesarios para acceder a este recurso. Si crees que esto es un error, por favor, contáctanos.</p>
        <div class="ahora">
            <h2>¿Qué puedes hacer ahora?</h2>
            <div class="list">
                <ul class="ahora-list">
                    <li>
                        <h3>Vuelve a la página de inicio:</h3>
                        <a href="/smart-parents/views/dashboard.php" class="a-reverse">Haz clic aquí para regresar a la página principal</a>
                    </li>
                    <li>
