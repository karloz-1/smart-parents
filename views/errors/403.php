...
// Redirige a la página de error 401 si no está logueado
//-----------------------------------------------------
session_start();
...
<head>
  ...
  <title>Smart Parents - 403 Forbidden</title>
  <!-- Estilos CSS -->
...
<body>
  ...
  <main>
    ...
    <p class="msj">No tienes permiso para ver esta página. <br><br> El error <span class="bold">403 Forbidden</span>
      indica que, aunque has iniciado sesión, tu cuenta no tiene los permisos necesarios para acceder a este recurso. Si
      crees que esto es un error, por favor, contáctanos.</p>
    <div class="ahora">
      ...
      <div class="list">
        <ul class="ahora-list">
          <li>
            ...
            <a href="/smart-parents/views/dashboard.php" class="a-reverse">Haz clic aquí para regresar a la página
              principal</a>
          </li>
          <li>
